...
const imgVariants = {
  ...
  animate: (custom) => ({
    ...
    x: 0,
    y: 0,
    rotateZ: custom === 0 ? -15 : custom === 1 ? 0 : 20,
  }),
};
  ...
  return (
    <div className="grid grid-cols-3 mx-auto max-w-screen-lg w-full">
      <div className="z-10 text-left col-span-2 flex gap-3 relative flex-col pt-[20vh]">
        ...
        >
          <h1
            className="bg-clip-text text-transparent bg-gradient-to-r from-blue-100 to-purple-100 text-5xl
          ...
          <button
            className="py-2 border border-white text-white w-[20vw] px-4 text-md tracking-widest
           uppercase mt-3"
          >
            See More
          </button>
